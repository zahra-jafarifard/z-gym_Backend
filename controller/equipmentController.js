...
exports.postCreate = (req , res , next) =>{
    ...
    .then(createdEquipment => {
        ...
        return res.status(201).json({message : `new equipment ${createdEquipment.dataValues.equipment_name} created...`})
    })
    .catch(e =>{
...
exports.postUpdate = (req , res , next) =>{
    ...
    .then(() => {
        res.status(200).json({message:'equipment name updated successfully...'})
    })
    .catch(() => {
